        ...
        <div class="w-full single-product-wrapper my-[60px]">
                ...
                <div class="w-full bg-white pb-[60px]">
                    <div class="mx-auto max-w-[1216px]">
                        <div class="justify-between w-full product-view lg:flex ">
                            ...
                            <div data-aos="fade-right" class="lg:w-1/2 xl:mr-[70px] lg:mr-[50px] aos-init" x-data="{ selectedImage: '{{ asset('storage/' . str_replace('\\', '/', $product->getPrincipalImage())) }}' }">
                                <div class="w-full">
                                    <div class="w-full h-[600px] border border-gray-500 flex justify-center items-center overflow-hidden relative mb-3">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        @foreach ($product->images as $item)
                                            <div class="w-[110px] h-[110px] p-[15px] border border-gray-500 cursor-pointer" @click="selectedImage = '{{ asset('storage/'.$item->image) }}'">
                            ...
                            <div class="flex-1">
                                <div class="w-full mt-10 product-details lg:mt-0"><span data-aos="fade-up"
                                    ...
                                    <p data-aos="fade-up" class="mb-4 text-xl font-medium capitalize text-qblack aos-init">{{ $product->name }}</p>
                                    ...
                                    <div data-aos="fade-up" class="flex items-center space-x-2 mb-7 aos-init"><span
                                            class="mt-2 text-sm font-semibold text-gray-900 line-through">{{ $product->specialPrice }}</span><span
                                            class="text-2xl font-bold text-red-500">{{ $product->price }}</span></div>
                                            
                                    
                                    <div data-aos="fade-up"
                                        class=" w-full flex items-center h-[50px] space-x-[10px] mb-[30px] aos-init">
                                        <div
                                            class="w-[120px] h-full px-[26px] flex items-center border border-gray-500">
                                            <div class="flex items-center justify-between w-full"><button type="button"
                                                    class="text-base text-qgray">-</button><span
                                                    class="text-qblack">1</span><button type="button"
                                                    class="text-base text-qgray">+</button></div>
                                        </div>
                                        <div
                                            class="w-[60px] h-full flex justify-center items-center border border-gray-500">
                                            <button type="button"><span><svg width="24" height="24"
                                        ...
                                        <div class="flex-1 h-full"><button type="button"
                                                class="w-full h-full text-sm font-semibold black-btn">Add To Cart</button>
                                        </div>
                                    </div>
                                    <div data-aos="fade-up" class="flex items-center w-full social-share aos-init"><span
                                            class="text-qblack text-[13px] mr-[17px] inline-block">Share This</span>
                                        <div class="flex items-center space-x-5"><span><svg width="10" height="16"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#3E75B2"></path>
                                                </svg></span><span><svg width="16" height="16" viewBox="0 0 16 16"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        ...
                                                        fill="#E12828"></path>
                                                </svg></span><span><svg width="18" height="14" viewBox="0 0 18 14"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
            ...
            <div class="product-des-wrapper w-full relative pb-[60px]">
                <div class="w-full mt-5 mb-10 tab-buttons sm:mt-0">
                    <div class="mx-auto max-w-[1216px]">
                        <ul class="flex space-x-12 ">
                            <li><span class="py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer border-qyellow text-qblack ">Description</span>
                            </li>
                            <li><span class="py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer border-transparent text-qgray">Reviews</span>
                            </li>
                            <li><span class="py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer border-transparent text-qgray">Seller Info</span></li>
                        </ul>
                    </div>
                ...
                <div class="tab-contents w-full min-h-[400px] ">
                    <div class="mx-auto max-w-[1216px]">
                        <div data-aos="fade-up" class="w-full tab-content-item aos-init">
                            {!!  $product->description !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full bg-white related-product">
                <div class="mx-auto max-w-[1216px]">
                    <div class="w-full py-[60px]">
                        ...
                        <div data-aos="fade-up"
                            class="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5 aos-init">
                            <div class="item">
                                <div class="relative w-full h-full overflow-hidden bg-white product-card-one group"
                                    ...
                                    <div class="product-card-img w-full h-[300px]"
                                        style="background: url(&quot;/assets/images/product-img-6.jpg&quot;) center center no-repeat;">
                                    </div>
                                    <div class="product-card-details px-[30px] pb-[30px] relative">
                                        <div
                                            ...
                                            <button type="button" class="yellow-btn">
                                                <div class="flex items-center space-x-3"><span><svg width="14"
                                                        ...
                                                        </svg></span><span>Add To Cart</span></div>
                                            </button>
                                        </div>
                                        <div class="reviews flex space-x-[1px] mb-3"><span><svg width="18"
                                                    height="17" viewBox="0 0 18 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z"
                                                        fill="#FFA800"></path>
                                                </svg></span><span><svg width="18" height="17" viewBox="0 0 18 17"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z"
                                                        fill="#FFA800"></path>
                                                    ...
                                                    <path
                                                        d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z"
                                                        fill="#FFA800"></path>
                                                </svg></span></div><a href="/single-product">
                                            <p
                                                class="title mb-2 text-[15px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600">
                                                Unisure aliqua repreh ex cupt qui elit officia</p>
                                        </a>
                                        <p class="price"><span
                                                class="main-price text-qgray line-through font-600 text-[18px]">$36.90</span><span
                                                class="offer-price text-qred font-600 text-[18px] ml-2">$16.43</span></p>
                                    </div>
                                    <div
                                        class="absolute flex flex-col space-y-2 transition-all duration-300 ease-in-out quick-access-btns group-hover:right-4 -right-10 top-20">
                                        <a href="#"><span
                                                class="flex items-center justify-center w-10 h-10 rounded bg-primarygray"><svg
